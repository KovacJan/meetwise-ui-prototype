    ...
    if (!dashboardData.isManager) {
      return (
        <ManagerDashboard
          ...
          monthlyMinutes={dashboardData.monthlyMinutes}
          annualMinutes={dashboardData.annualMinutes}
          calendarConnected={dashboardData.calendarConnected}
          calendarWriteEnabled={dashboardData.calendarWriteEnabled}
          lastCalendarSyncAt={dashboardData.lastCalendarSyncAt}
          lastCalendarSyncStatus={dashboardData.lastCalendarSyncStatus}
          lastCalendarSyncError={dashboardData.lastCalendarSyncError}
          isEmployeeView
        />
      );
    }
