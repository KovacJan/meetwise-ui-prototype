    ...
    startTransition(async () => {
      ...
      try {
        ...
        if (!res.ok) {
          ...
          setError(
            resolveApiErrorMessage(json, tErrors, t("submitError")),
          );
          return;
        }
  ...
  function handleSubmitAll() {
    ...
    startSubmitAllTransition(async () => {
      ...
      try {
        ...
        setSubmitAllError(t("submitError"));
      }
    });
  }
    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 w-full min-w-0 px-4 sm:px-6 py-4 sm:py-5 overflow-y-auto pb-28 md:pb-5 overflow-x-hidden">
          ...
          {hasAny && (
            <div className="mt-4 flex flex-col items-end gap-2 pb-2">
              {submitAllError && (
                <p className="text-xs text-destructive-foreground w-full sm:text-right">
                  {submitAllError}
                </p>
              )}
              <button
